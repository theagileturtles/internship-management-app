...
export default async function handler(req, res) {
    ...
    try {
        ...
        let response = await query(connection)(
            "SELECT BIN_TO_UUID(messages.uuid) UUID, BIN_TO_UUID(messages.sender_uuid) AS senderUUID,  first_name, last_name, title, subject, messages.created_at, messages.read FROM internship_management_app.messages "+
